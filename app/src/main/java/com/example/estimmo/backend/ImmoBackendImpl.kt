...
class ImmoBackendImpl @Inject constructor():ImmoBackendInterface{
    ...
    override fun calculPriceHome(x1: Double, x2: Double, x3: Double, x4: Double): Double {
        ...
        return intercept + coef[1] * x1 + coef[2] * x2 + coef[3] * x3 + coef[4] * x4 + coef[5] * x1 * x2 + coef[6] * x1 * x3 + coef[7] * x1 * x4 + coef[8] * x2 * x3 + coef[9] * x2 * x4 + coef[10] * x3 * x4
    }
    ...
    override fun calculPriceApt(x1: Double, x2: Double, x3: Double, x4: Double): Double {
        ...
        return intercept1 + coef1[1] * x1 + coef1[2] * x2 + coef1[3] * x3 + coef1[4] * x4 + coef1[5] * x1 * x2 + coef1[6] * x1 * x3 + coef1[7] * x1 * x4 + coef1[8] * x2 * x3 + coef1[9] * x2 * x4 + coef1[10] * x3 * x4
    }
